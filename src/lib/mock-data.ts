...
export const CATEGORIES: Category[] = [
  ...
  { slug: "ironing-services", name: "Ironing Services", icon: "Shirt", blurb: "Crisp, ready in hours.", image: img("1489274495757-95c7c837b101"), tier: 10 },
  ...
  { slug: "domestic-cleaning", name: "Domestic Cleaning", icon: "Sparkles", blurb: "A spotless home.", image: img("1527515637462-cff94eecc1ac"), tier: 20 },
  ...
  { slug: "pressure-washing", name: "Pressure Washing", icon: "Droplet", blurb: "Clean driveways, decks and walls.", image: img("1584622650-18759f048b51"), tier: 20 },
  { slug: "carpet-cleaning", name: "Carpet Cleaning", icon: "Sparkle", blurb: "Fresh carpets, fast turnaround.", image: img("1558618666-fcd25c85cd64"), tier: 20 },
  { slug: "plumbers", name: "Plumbers", icon: "Pipette", blurb: "Licensed local plumbers.", image: img("1504148455328-4adc7f820df4"), tier: 40 },
  { slug: "electricians", name: "Electricians", icon: "Zap", blurb: "Safe and certified.", image: img("1621905251189-08b45d6a269e"), tier: 40 },
  { slug: "builders", name: "Builders", icon: "HardHat", blurb: "Renos and new builds.", image: img("1541888941259-792739460572"), tier: 40 },
  { slug: "painters", name: "Painters", icon: "PaintRoller", blurb: "Interior and exterior.", image: img("1589939705384-5185138a04b9"), tier: 40 },
  { slug: "roofers", name: "Roofers", icon: "Home", blurb: "Roof repairs and replacements.", image: img("1632759162414-239648a9277b"), tier: 40 },
  { slug: "concreters", name: "Concreters", icon: "Square", blurb: "Strong slabs, paths and driveways.", image: img("1517646272420-4749f1a20a46"), tier: 40 },
  { slug: "plasterers", name: "Plasterers", icon: "Layers", blurb: "Smooth walls and ceilings.", image: img("1504917595217-d4dc5ebe6122"), tier: 40 },
  { slug: "landscapers", name: "Landscapers", icon: "Leaf", blurb: "Beautiful outdoor spaces.", image: img("1558904541-efa843a96f01"), tier: 40 },
  { slug: "photographers", name: "Photographers", icon: "Camera", blurb: "Great photos for every job.", image: img("1493863641943-9b689da23b63"), tier: 40 },
  { slug: "fencing-contractors", name: "Fencing Contractors", icon: "Shield", blurb: "Secure and smart fencing.", image: img("1500322969170-1e991e4fdf52"), tier: 40 },
];
